...
os.chdir("C:/Users/Laboratorio/AutoMeasureLCwithPolorizationCamera/4.29onlyKLC3TwoVols/5safternoon")
excelName=input("please input a filename for saving data:")
start_time = time.time()
filename=0
maxinumber=9 # this value is for the upper bound in the reading imgae loop
