...
os.chdir("C:/Users/Laboratorio/StokeMatix/CaptureHub")
imName=[0,32,64,128,160,192,224,255] #,[0,16,32,48,64,80,96,112,128,144,160,176,192,208,224,240,255]
i=0
s0_group=[]
s1_group=[]
s2_group=[]
for i in range(len(imName)):
    ...
    im_0=leftP[600:700,550:650] #(611-100/612+100) (654-200/655+200)
    im_45=leftP[1600:1700,550:650] #(1636-100/1637+100) (654-200/655+200)

    im_n45=rightP[600:700,550:650]
    im_90=rightP[1600:1700,550:650]
...
plt.plot(imName,s0_group,label="S0")
plt.plot(imName,s1_group,label="S1")
plt.plot(imName,s2_group,label="S2")
plt.plot(imName,s3_group,label="S3")
